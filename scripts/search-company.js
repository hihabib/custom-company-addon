function implementCompanySearch(parentElementId, isRedirectAllowed = false){
     ...
     */
    const companySearchResult = document.querySelector(`#${parentElementId} .company_search_result`);
     ...
     */
    const companySearchInput = document.querySelector(`#${parentElementId} .company_search_form input`);
